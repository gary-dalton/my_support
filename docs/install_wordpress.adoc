...
Backing up files is an important task in maintaining and recovering your WordPress site. Plugins are available to help with this task but I prefer to automate this task with script. First, I will run through the manual process and then share the script.
